...
const createTables = async () => {
  const queries = [
    ...
    `CREATE INDEX IF NOT EXISTS idx_orders_mesero ON orders(mesero_id)`,
    ...
    `CREATE INDEX IF NOT EXISTS idx_ingredients_stock ON ingredients(stock_actual, stock_minimo)`,
    `CREATE INDEX IF NOT EXISTS idx_ingredients_activo ON ingredients(activo)`,
